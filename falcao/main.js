...
.setTween(TweenMax.to(".background13", 3, {y:"-12%", ease:Power4.easeNone}))
.addTo(controller);
...
.setTween(TweenMax.to(".background14", 3, {y:"-30%", x:"5%", rotation:5, ease:Power4.easeNone}))
.addTo(controller);
...
.setTween(TweenMax.to(".background15", 2, {y:"-20%", ease:Power4.easeNone}))
.addTo(controller);
